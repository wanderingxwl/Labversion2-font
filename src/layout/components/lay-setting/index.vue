...
const stretchTypeOptions = computed<Array<OptionsType>>(() => {
  return [
    {
      label: "Fixed",
      tip: "Simplified layout to help you find information effortlessly.",
      value: "fixed"
    },
    {
      label: "Custom",
      tip: "Resolution range: 1280 to 1600",
      value: "custom"
    }
  ];
});
  ...
  return [
    {
      ...
      icon: DayIcon,
      theme: "light",
      tip: "A fresh start, illuminating a comfortable workspace.",
    ...
    },
    {
      ...
      icon: DarkIcon,
      theme: "dark",
      tip: "Moonlight Prelude — Enchanted by the serene elegance of the night.",
      iconAttrs: { fill: isDark.value ? "#fff" : "#000" }
    },
    {
      label: "System",
      icon: SystemIcon,
      theme: "system",
      tip: "In sync with time — the interface shifts naturally with dawn and dusk.",
      iconAttrs: { fill: isDark.value ? "#fff" : "#000" }
    }
  ];
});
...
<template>
  <LayPanel>
    <div class="p-5">
      ...
      <p class="mt-5 text-sm font-medium dark:text-white">UI Display</p>
      <ul class="setting">
        <li>
        ...
        <li>
          <span class="dark:text-white">Colorblind Mode</span>
          <el-switch
        ...
        <li>
          <span class="dark:text-white">Collapse Tab</span>
          <el-switch
        ...
        <li>
          <span class="dark:text-white">Persistent Tabs</span>
          <el-switch
